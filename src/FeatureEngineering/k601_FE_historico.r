...
#Comentar si no se quiera que funcione
setorder( dataset, foto_mes, numero_de_cliente )
Lags( cols_lagueables, 2, TRUE )   #calculo los lags de orden  i
...
#Comentar si no se quiera que funcione
setorder( dataset, foto_mes, numero_de_cliente )
Lags( cols_lagueables, 3, TRUE )   #calculo los lags de orden  i
...
#Comentar si no se quiera que funcione
setorder( dataset, foto_mes, numero_de_cliente )
Lags( cols_lagueables, 4, TRUE )   #calculo los lags de orden  i
...
#Comentar si no se quiera que funcione
setorder( dataset, foto_mes, numero_de_cliente )
Lags( cols_lagueables, 5, TRUE )   #calculo los lags de orden  i
...
#Comentar si no se quiera que funcione
setorder( dataset, foto_mes, numero_de_cliente )
Lags( cols_lagueables, 6, TRUE )   #calculo los lags de orden  i
...
#Comentar si no se quiera que funcione
setorder( dataset, foto_mes, numero_de_cliente )
Lags( cols_lagueables, 12, TRUE )   #calculo los lags de orden  i
