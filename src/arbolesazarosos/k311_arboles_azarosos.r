...
set.seed(111599) #Establezco la semilla aleatoria, cambiar por SU primer semilla
...
entrega  <- as.data.table( list( "numero_de_cliente"= dapply[  , numero_de_cliente],
                                 "Predicted"= as.numeric(probabilidad_ensemble > 1/65) ) ) #genero la salida
...
fwrite( entrega, 
        file= "./labo/exp/KA2101/K311_005.csv", 
        sep= "," )
