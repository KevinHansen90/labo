...
AgregarVariables  <- function( dataset )
{
  ...
  #Experimentos
  dataset[  , consumos_tarjetas_total  := mtarjeta_visa_consumo+mtarjeta_master_consumo ]
  dataset[  , prestamos_total  := mprestamos_personales+mprestamos_prendarios+mprestamos_hipotecarios ]
  ...
  dataset[  , plata_con_banco_normalizada := plata_con_banco ]
  dataset[ cliente_antiguedad==1 , plata_con_banco_normalizada := plata_con_banco  * 2 ]
  dataset[ cliente_antiguedad==2 , plata_con_banco_normalizada:= plata_con_banco  * 1.5 ]
  dataset[ cliente_antiguedad==3 , plata_con_banco_normalizada := plata_con_banco  * 1.2 ]
  ...
  dataset[  , mrent_sobre_plata_con_banco  := mrentabilidad / plata_con_banco ]
  dataset[  , mrent_sobre_plata_con_banco_normalizada  := mrentabilidad / plata_con_banco_normalizada ]
  dataset[  , mrent_sobre_saldo  := mrentabilidad / mcuentas_saldo ]
  
  dataset[  , mrent_normalizada := mrentabilidad ]
  dataset[ cliente_antiguedad==1 , mrent_normalizada := mrentabilidad  * 5 ]
  dataset[ cliente_antiguedad==2 , mrent_normalizada := mrentabilidad  * 2 ]
  dataset[ cliente_antiguedad==3 , mrent_normalizada := mrentabilidad  * 1.2 ]
  dataset[  , rent_normalizada_sobre_rent_annual  := mrent_normalizada / mrentabilidad_annual ]
  dataset[  , rent_normalizada_sobre_plata_con_banco  := mrent_normalizada / plata_con_banco ]
  dataset[  , rent_normalizada_sobre_plata_con_banco_normalizada  := mrent_normalizada / plata_con_banco_normalizada ]
  
  dataset[  , inversiones_total  := (plazo_fijo_total+minversion1_pesos+inversiones_sin_pf) ]
  ...
  dataset[  , platabanco_por_trxmes  := plata_con_banco * trxmes ]
  dataset[  , balance_cliente_por_trxmes  := balance_cliente * trxmes ]
  dataset[  , rent_sobre_plata_por_trx_mes  := mrent_sobre_plata_con_banco * trxmes ]
  dataset[  , rent_sobre_plata_por_trx_mes_normalizado  := rent_normalizada_sobre_plata_con_banco_normalizada * trxmes ]
